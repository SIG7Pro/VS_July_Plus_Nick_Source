//credit to whoever made this, sorry I forgot where I got this from, notes i wrote down will appear
var vg:FlxSprite = new FlxSprite().loadGraphic(Paths.image('events/redVG'));
//editingchars
var pixelsonic:Charatcer = new Character(400,250,mod + ":pixelnick");
var bfpixel:Boyfriend = new Boyfriend(800,250,mod + ":pixelbf");
var greenhill:FlxSprite = new FlxSprite(0,0).loadGraphic(Paths.image("backgrounds/ycr/GreenHill"));
//returning old chars
var d:Character = new Character(300,140,mod +":psychonick");
