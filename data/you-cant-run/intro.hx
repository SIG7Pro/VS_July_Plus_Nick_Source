...
var startCircle:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('StartScreens/Circle-you-cant-run'));
var startText:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('StartScreens/Text-you-cant-run'));
